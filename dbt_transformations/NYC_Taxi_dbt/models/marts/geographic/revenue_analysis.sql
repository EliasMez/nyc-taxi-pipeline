...
left join {{ ref('dim_locations') }} as loc_pickup on metrics.pulocationid = loc_pickup.location_id
left join {{ ref('dim_locations') }} as loc_dropoff on metrics.dolocationid = loc_dropoff.location_id
