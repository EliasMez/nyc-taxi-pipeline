...
COMMENT ON ROLE ROLE_TRANSFORMER_PLACEHOLDER IS 'Role for data transformation (DBT)'; -- noqa: PRS
...
CREATE USER IF NOT EXISTS USER_DEV_PLACEHOLDER
    ...
    DEFAULT_NAMESPACE = 'DW_NAME_PLACEHOLDER.SCHEMA_RAW_SCHEMA_PLACEHOLDER'
