...
GRANT ALL ON ALL TABLES IN SCHEMA DW_NAME_PLACEHOLDER.SCHEMA_RAW_SCHEMA_PLACEHOLDER TO ROLE ROLE_TRANSFORMER_PLACEHOLDER;
GRANT ALL ON FUTURE TABLES IN SCHEMA DW_NAME_PLACEHOLDER.SCHEMA_RAW_SCHEMA_PLACEHOLDER TO ROLE ROLE_TRANSFORMER_PLACEHOLDER;
GRANT USAGE ON FILE FORMAT DW_NAME_PLACEHOLDER.SCHEMA_RAW_SCHEMA_PLACEHOLDER.PARQUET_FORMAT_PLACEHOLDER TO ROLE ROLE_TRANSFORMER_PLACEHOLDER;
...
REVOKE SELECT ON ALL VIEWS IN SCHEMA DW_NAME_PLACEHOLDER.SCHEMA_FINAL_SCHEMA_PLACEHOLDER FROM ROLE ROLE_DATA_SCIENTIST_PLACEHOLDER;
REVOKE SELECT ON FUTURE VIEWS IN SCHEMA DW_NAME_PLACEHOLDER.SCHEMA_FINAL_SCHEMA_PLACEHOLDER FROM ROLE ROLE_DATA_SCIENTIST_PLACEHOLDER;
